...
<xsl:stylesheet version="2.0" 
	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				<title>Geekonjava.com XML Sitemap</title>
			...
			<body>
				<div id="content">
					<h1>Geekonjava.com XML Sitemap</h1>
					<p class="expl">
						Genrated by free xml sitemap generator designed by <a href="http://geeksonjava.com">geekonjava.com</a>, Get the source from.
					</p>
